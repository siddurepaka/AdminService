...
namespace TestingAdminService_Category
{
    ...
    class TestManagerRepository
    {
        ...
        public void setup()
        {
            _repo = new ManagerRepository(new AdminRepositoty(new EmartDBContext()));
        ...
        [TestCase(32, "electronics", "electric gadgets")]
        [TestCase(33, "clothings", "Wholesale")]
        [TestCase(34, "HomeNeeds", "All home needies")]
        ...
        [TestCase(100, 2, "def", "pens", 4)]
        [TestCase(101, 1, "lkj", "cello", 5)]
        [TestCase(102, 1, "dsa", "butterflow", 3)]
